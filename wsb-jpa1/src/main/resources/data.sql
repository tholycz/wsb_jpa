...
insert into doctor (doctor_id, doctor_number, email, first_name, last_name, specialization, telephone_number, address_id)
            values (1, 123, 'maciek.kowalski@test.com', 'Maciek', 'Kowalski', 'weterynaria', '676787878', 1), (2, 456, 'martyna.nowak@test.com', 'Martyna', 'Nowak', 'pediatria', '23127878', 2);

insert into patient (patient_id, date_of_birth, email, first_name, last_name, patient_number, telephone_number, address_id)
            values (1, '1999-02-17', 'tomasz.kosakowski@test.com', 'Tomasz', 'Kosakowski', 564, '893849839', 3), (2, '1998-01-3', 'anna.bosak@test.com', 'Anna', 'Bosak', 989, '787283782', 4);
